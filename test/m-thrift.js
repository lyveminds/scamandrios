...
describe('thrift', function()
{
    ...
    it('cf.get can error', function()
    {
        ...
        [
            ...
            promise.fail(_.identity).should.eventually.have.property('name', 'HelenusInvalidRequestException').then(function(error)
            {
    ...
    it('row `nameSlice`', function(done)
    {
    ...
    it('row `toString` and `inspect`', function()
    {
