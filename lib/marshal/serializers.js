...
Serializers.encodeMap = function encodeMap(map, types)
{
    var keySize = new Buffer(2),
        ...
        results = new Buffer(0);

    _.forOwn(map, function(value, key)
    {
        var serializedKey = module.exports[types[0]](key);
        keySize.writeUInt16BE(serializedKey.length, 0);

        var serializedValue = module.exports[types[1]](key);
...
module.exports =
{
    ...
    'MapType': Serializers.encodeBinary,
    'SetType': Serializers.encodeBinary,
