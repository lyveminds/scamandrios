...
var DISCOVER_Q = new Buffer('select * from system.peers');
...
exports.discover = function(node)
{
    ...
    .then(function(reply)
    {
        ...
        {
            var tokens = row.get('tokens').value;
    ...
    .then(function()
    {
        ...
        opts =
        {
            host: nodes[_.random(nodes.length - 1)] + ':9160',
            cqlVersion: '3.0.0'
        };
